...
public class Querys {
	 ...
	 * 
	 */
	public LinkedHashMap<String, QueryTermMap> generate(InvertedIndex invertedIndex,String term) {
		...
		return null;
		 */
		queryTermSet = getQueryTermSet(term, invertedIndex);
		queryMap.put(term, queryTermSet);
		return queryMap;
	}
